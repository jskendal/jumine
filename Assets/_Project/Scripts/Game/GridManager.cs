    ...
    void GenerateFutureRow()
    {
        ...
        for (int c = 0; c < columns; c++)
        {
            ...
            if (rend != null)
            {
                ...
                rend.material.color = new Color(currentColor.r, currentColor.g, currentColor.b, 0.5f);
            }
    ...
    public void InsertRow()
    {
        ...
        for (int r = 1; r < rows; r++)
        {
            for (int c = 0; c < columns; c++)
            {
                ...
                // Rendre opaque
                Renderer rend = gridCells[r, c].GetComponent<Renderer>();
                if (rend != null)
                {
                    Color currentColor = rend.material.color;
                    rend.material.color = new Color(currentColor.r, currentColor.g, currentColor.b, 1f);
                }
            }
        }
        ...
        for (int c = 0; c < columns; c++)
        {
            ...
            // Rendre opaque
            Renderer rend = futureRow[c].GetComponent<Renderer>();
            if (rend != null)
            {
                Color currentColor = rend.material.color;
                rend.material.color = new Color(currentColor.r, currentColor.g, currentColor.b, 1f);
